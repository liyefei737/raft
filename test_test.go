...
func TestReElection2A(t *testing.T) {
	...
	// re-join of last nodeId shouldn't prevent leader from existing.
	cfg.connect(leader2)
	cfg.checkOneLeader()
	fmt.Println(" re-join of last nodeId shouldn't prevent leader from existing.")
